...
IT = dict(
    ...
    nonincluso=(
        ...
        "Firenze (circa € 421,00), dovuto solo se il ritrovo o il rientro cadono dentro la ZTL: lo confermiamo "
    ...
    note=[
        ("<b>Punto di ritiro a Firenze.</b> Ci serve l'indirizzo esatto di partenza, hotel o punto di incontro: "
         ...
         "permesso a parte, circa € 421,00, non compreso nel prezzo. Fuori dalla ZTL non ci sono oneri "
...
EN = dict(
    ...
    nonincluso=(
        ...
        "Florence (about € 421.00), due only if the meeting or drop-off point falls inside the restricted traffic "
    ...
    note=[
        ("<b>Pick-up point in Florence.</b> We need the exact departure address, hotel or meeting point: if it "
         ...
         "separate permit, about € 421.00, not included in the price. Outside that zone there are no extra "
